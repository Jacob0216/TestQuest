      ...
      <div style={{ display: 'flex', gap: '20px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ width: '280px' }}>
          ...
          <div style={{ 
            ...
            <p style={{ color: '#888', fontSize: '0.9rem', marginBottom: '20px' }}>Bug Tester</p>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '20px', marginBottom: '20px' }}>
            <div style={{ 
              ...
              <div>
                <div style={{ color: '#888', fontSize: '0.85rem', marginBottom: '5px' }}>Total Bugs</div>
            ...
            <div style={{ 
              ...
              <div>
                <div style={{ color: '#888', fontSize: '0.85rem', marginBottom: '5px' }}>Resolved</div>
                <div style={{ color: 'white', fontSize: '1.8rem', fontWeight: 'bold' }}>0</div>
              </div>
            </div>
            ...
            <div style={{ 
              ...
              <div>
                <div style={{ color: '#888', fontSize: '0.85rem', marginBottom: '5px' }}>Pending</div>
                <div style={{ color: 'white', fontSize: '1.8rem', fontWeight: 'bold' }}>0</div>
              </div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <h6 style={{ color: 'white', marginBottom: '25px', fontSize: '1.1rem' }}>Current Projects</h6>
