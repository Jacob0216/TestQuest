...
function TesterDashboard({ onProjectClick, onCategorize, onProfile }) {
  return (
    <div style={{ width: '100%', minHeight: '100vh', backgroundColor: '#0E0F15' }} className="text-light p-4">
      ...
      <h3 className="mb-4">Available Projects</h3>

      <div className="row gx-4 gy-5">
        {Array.from({ length: 6 }).map((_, index) => (
          <div className="col-md-4 d-flex justify-content-center" key={index}>
            <div 
              className="card text-light h-100 shadow-sm border-0" 
              style={{ 
